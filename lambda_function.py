...
def validation(age, investment_amount):
    ...
    if age is not None and (int(age) < 0 or int(age) > 65):
        return build_validation_result(
            False,
            "age",
            "You should be ,more than 0 and less than 65 years of age to use this service, please enter a different age.",
        )
...
def recommend_portfolio(intent_request):
    ...
    if risk_level == "None":
        ...
        initial_recommendation = "0% bonds (AGG), 10% equities (SPY)"
